...
keys.globalkeys = gears.table.join(
	...
	awful.key({}, "XF86AudioRaiseVolume", function () lame.widget.volume.inc() end,
		{description = "volume up", group = "hotkeys"}),
	awful.key({}, "XF86AudioLowerVolume", function () lame.widget.volume.dec() end,
        {description = "volume down", group = "hotkeys"}),
	awful.key({}, "XF86AudioMute", function () lame.widget.volume.toggle_mute() end,
        {description = "toggle mute", group = "hotkeys"}),
    awful.key({ altkey, "Control" }, "m", function () lame.widget.volume.toggle_mute() end,
        {description = "toggle mute", group = "hotkeys"}),
...
keys.quickmedia_keys = gears.table.join(
	...
	awful.key({}, "2",
		function () lame.widget.volume.inc() end),
	awful.key({ "Shift" }, "s",
		function () lame.widget.music.playerctl_play_pause() end),
	awful.key({ "Shift" }, "w",
		function () lame.widget.music.playerctl_stop() end),
	awful.key({ "Shift" }, "d",
		function () lame.widget.music.playerctl_next() end),
	awful.key({ "Shift" }, "a",
		function () lame.widget.music.playerctl_previous() end),
	awful.key({ "Shift" }, "q",
